...
/*
void RecvUartStr(char* holder,uint8_t sizeo_string){
  
    holder[0] = RecvUartChar();
    holder[1] = RecvUartChar();
    holder[2] = RecvUartChar();
    holder[3] = '\0';
 ...
 */
 ...
 /*
    for (uint8_t i = 0; i< sizeo_string - 1 ; i++){
        
        holder[i] = RecvUartChar();
    }
               
    holder[sizeo_string - 1 ] = '\0';
